 ...
 */
public class TfLLineParserMissingLineName {

    private String lineData;

    @Before
    public void setUp() throws Exception {
        DataProvider dataProvider = new FileDataProvider("./res/raw/MissingLineName.json");
        lineData = dataProvider.dataSourceToString();
    }

    @Test(expected = TfLLineDataMissingException.class)
    public void missingLineName() throws JSONException, TfLLineDataMissingException {
