...
public class ArrivalBoardListFragment extends ListFragment {
    ...
    public ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation() {
        List<ArrivalBoard> arrivalBoardList = StationManager.getInstance().getSelected().getArrivalBoards();
        ArrayList<ArrivalBoard> result = new ArrayList<ArrivalBoard>(arrivalBoardList);
        return result;
    }
