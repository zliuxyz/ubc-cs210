...
public class BoardTest {
	...
	public void testCanMoveTo() {
		...
		assertTrue(new_x <= b.getBoardWidth());
		assertTrue(new_y <= b.getBoardHeight());
		assertFalse(b.canMoveTo(new_x, new_y));
	...
	public void testMoveTo() {
		...
		assertTrue(b.canMoveTo(new_x, new_y-1));
		b.moveTo(p, new_x, new_y-1);
		assertEquals(new_x, p.getX());
		assertEquals(new_y-1, p.getY());
	}
