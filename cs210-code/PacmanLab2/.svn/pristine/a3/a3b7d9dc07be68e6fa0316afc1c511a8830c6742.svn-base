...
public class Board {
	...
	// FILL IN FOR TASK M3
	// Requires: All the sprites are valid in this board.
	// Modifies: this
	// Effects: tick the board, the Pacman, the trackerMonsters, and the tandomMonsters.
	...
	// Requires: nothing
	// Modifies: nothing
	// Effects: checks whether the game is over or not. If all the food pellets are gone, or the Pacman gets caught, the
	//          game is over and returns true; otherwise, produces false
	...
	// Requires: nothing
	// Modifies: nothing
	// Effects: check whether the given position(new_x, new_y) is a place that a Sprite move to or not.
	...
	// Requires: nothing
	// Modifies: nothing
	// Effects: get the Pacman of this board
